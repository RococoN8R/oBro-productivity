...
class oBroSettingsTab extends PluginSettingTab {
   ...
   display() {
      ...
      new Setting(this.containerEl).setName("Search pages").setHeading()
      ...
      new Setting(this.containerEl).setName("Search tags").setHeading()
      ...
      new Setting(this.containerEl).setName("Task formatting").setHeading()
